    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="px-4 py-6">
        ...
        <section className="mt-8">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Assessment Patterns</h2>
          ...
          <div className="space-y-4">
            <div className="bg-white p-4 rounded-xl shadow-sm">
              ...
              <p className="text-sm text-gray-500">Consistently positive mood with slight dip on Wednesday</p>
            </div>

            <div className="bg-white p-4 rounded-xl shadow-sm">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-medium text-gray-700">Exercise Consistency</span>
                <span className="text-sm text-green-600">4/5 target days</span>
              </div>
            ...
            <div className="bg-white p-4 rounded-xl shadow-sm">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-medium text-gray-700">Meal Balance</span>
              </div>
              <div className="flex items-center space-x-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-green-500">
                  <path fillRule="evenodd" d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12zm13.36-1.814a.75.75 0 10-1.22-.872l-3.236 4.53L9.53 12.22a.75.75 0 00-1.06 1.06l2.25 2.25a.75.75 0 001.14-.094l3.75-5.25z" clipRule="evenodd" />
                </svg>
                <span className="text-sm text-gray-500">All meals balanced for 5 consecutive days</span>
              </div>
            </div>
          </div>
        </section>
