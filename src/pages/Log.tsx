...
import { ArrowLeft, Plus, Calendar, PersonRunning, Dumbbell, Utensils, Check, X } from "lucide-react";
            ...
            <div className="p-4 bg-white border border-gray-200 rounded-xl">
              <div className="flex items-start">
                <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center mr-3">
                  <PersonRunning className="text-green-600" size={20} />
                </div>
          ...
          <div className="absolute bottom-0 w-full bg-white rounded-t-2xl p-6">
            ...
            <div className="grid grid-cols-3 gap-3 mb-6">
              <button className="p-4 border border-gray-200 rounded-xl flex flex-col items-center">
                <PersonRunning className="text-blue-900 mb-2" size={24} />
                <span className="text-sm text-gray-900">Run</span>
              </button>
              <button className="p-4 border border-gray-200 rounded-xl flex flex-col items-center">
                {/* Using PersonRunning as placeholder since we need to use approved icons */}
                <PersonRunning className="text-blue-900 mb-2" size={24} />
